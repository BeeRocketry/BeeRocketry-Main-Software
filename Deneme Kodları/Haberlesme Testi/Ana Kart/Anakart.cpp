...
------------------------
    Ana Aviyonik sistem,  haberleşme  testini  gerçekleştirmek üzere  setup()  fonksiyonu  ile  ilk  olarak  GPS  ve  RF
UART port ayarlamalarını yapacak olup sonrasında RF modülünün çip ayarlamalarını yapacaktır.
...
Cihaz Adresi (High / Low)   --  0x03 0x08
